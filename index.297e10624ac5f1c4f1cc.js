"use strict";
(self["webpackChunksnv_react_local"] = self["webpackChunksnv_react_local"] || []).push([[624],{
...
var ProceduresTabs = function ProceduresTabs(props) {
  ...
  var proceduresTabsClass = classnames_default()("procedures".concat(queryNumber, "__tabs"));
  var proceduresMenuClass = classnames_default()("procedures".concat(queryNumber, "__menu"));
  var menuClass = classnames_default()("menu".concat(queryNumber));
  var menuProceduresClass = classnames_default()("menu-procedures".concat(queryNumber));
  var menuItemClass = classnames_default()("menu".concat(queryNumber, "__item"));
  var menuItemTabClass = classnames_default()("menu".concat(queryNumber, "__item-tab"));
  var menuLinkClass = classnames_default()("menu".concat(queryNumber, "__link"));
  var menuLinkTabClass = classnames_default()("menu".concat(queryNumber, "__link-tab"));
  var tabsClass = classnames_default()("tabs".concat(queryNumber));
  var tabsProceduresClass = classnames_default()("tabs-procedures".concat(queryNumber));
  var tabsBodyClass = classnames_default()("tabs".concat(queryNumber, "__body"));
  var tabsFaceClass = classnames_default()("tabs".concat(queryNumber, "__face"));
  var tabsSliderClass = classnames_default()("tabs".concat(queryNumber, "__slider"));
...
function Procedures(props) {
  var queryNumber = (0,funcQueryNumber/* default */.A)();
  var proceduresClass = classnames_default()("procedures".concat(queryNumber));
  var containerClass = classnames_default()("container".concat(queryNumber));
  var containerProceduresClass = classnames_default()("container-procedures".concat(queryNumber));
