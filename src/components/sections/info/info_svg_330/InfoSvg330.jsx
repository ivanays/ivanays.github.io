...
import { InfoSvg330Group0 } from './info_svg_330_group_0';
import { InfoSvg330Group1 } from './info_svg_330_group_1';
import { InfoSvg330Group2 } from './info_svg_330_group_2';

export const InfoSvg330 = ({
    idSvg,
    xlinkHref,
    idTitle1,
    idText1,
    ...
    return (
        <>
            ...
            >
                ...
                <>
                    {idSvg === "info-svg-0" ? <InfoSvg330Group0 /> : null}
                    {idSvg === "info-svg-1" ? <InfoSvg330Group1 /> : null}
                    {idSvg === "info-svg-2" ? <InfoSvg330Group2 /> : null}
                </>
